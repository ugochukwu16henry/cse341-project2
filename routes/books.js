...
router.put("/:id", isAuthenticated, validateObjectId, validateBook, booksController.updateBook); // <--- PROTECTED

// DELETE book (Protected)
router.delete("/:id", isAuthenticated, validateObjectId, booksController.deleteBook); // <--- PROTECTED
